...
SECRET_KEY = 'django-insecure-^u6j-lks-h=@t^pykh7hn5_h8$dk^(1-=kb)^6ossm^^q!xq@-'
...
# 以下を追加　””urls.pyのurlpatternsのname"
LOGIN_URL = "login"  # ログインページを指定LOGIN_REDIRECT_URL = "friends"  # ログイン成功後に遷移するページを指定
